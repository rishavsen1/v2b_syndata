...
the generic runner (configs/_campus_base_split/ + tools/campus/run_campus.sh).
...
Usage:  uv run python tools/campus/split_campus_config.py 20 50 10_new
...
def split(tag: str) -> int:
    ...
    for i, b in enumerate(buildings, start=1):
        ...
        text = (f"# {src.name} building {i}/{len(buildings)} — single-building split for a\n"
                ...
                f"# Auto-generated by tools/campus/split_campus_config.py; edit {src.name} + re-split.\n")
