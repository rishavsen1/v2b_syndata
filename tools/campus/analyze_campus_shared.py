...
(generate-multi with output_mode: shared → month-major tree
 ...
 dso_commands.csv is campus-wide). This is the sibling of tools/campus/analyze_campus.py
...
Run:  uv run python tools/campus/analyze_campus_shared.py --base data/output/campus20
...
<main>
  ...
  <p class="muted">Generated by <code>tools/campus/analyze_campus_shared.py</code>. Per-sample metrics in <code>analysis_summary.csv</code>.</p>
</main>"""
