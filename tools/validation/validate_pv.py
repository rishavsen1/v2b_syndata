...
Usage:
    uv run python tools/validation/validate_pv.py                # defaults = WS-B config
    uv run python tools/validation/validate_pv.py --strict
"""
...
*(generated by `tools/validation/validate_pv.py` — KDD_READINESS #8 / submission-plan WS-B)*
...
- Regenerate: `uv run python tools/validation/validate_pv.py`
