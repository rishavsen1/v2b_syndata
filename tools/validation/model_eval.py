...
Usage:  python tools/validation/model_eval.py [--out docs/MODEL_SELECTION.md] [--seed 0]
"""
...
def main() -> int:
    ...
    lines.append("_Auto-generated by `tools/validation/model_eval.py`. `*` = model the generator "
