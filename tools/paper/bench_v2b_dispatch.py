...
(machine-readable; consumed by tools/paper/repro_paper.py step ``collect``), or
...
Usage:
    uv run python tools/paper/bench_v2b_dispatch.py
    uv run python tools/paper/bench_v2b_dispatch.py --data-dir <unit> --out-dir <dir>
    uv run python tools/paper/bench_v2b_dispatch.py --skip-acnsim
    uv run python tools/paper/bench_v2b_dispatch.py --contended [--feeder-ratio 0.125]
"""
...
def write_outputs(data_dir: Path, out_dir: Path, result: dict) -> None:
    ...
    L = [
        ...
        "",
        "_Auto-generated by `tools/paper/bench_v2b_dispatch.py`. Do not edit by "
    ...
    L += [
        ...
        "tools/paper/repro_paper.py --steps v2b_dispatch` (or run this script "
        "directly).",
        "",
    ]
...
def write_contended_outputs(data_dir: Path, out_dir: Path,
    ...
    L = [
        ...
        "cap",
        "",
        "_Auto-generated by `tools/paper/bench_v2b_dispatch.py --contended`. Do not "
    ...
    L += [
        ...
        "",
        "Repro: `uv run python tools/paper/repro_paper.py --steps contended_bench` "
