...
Scales are the fitted cohorts (ACN: 632 of 635 loaded users assigned;
ElaadNL: workplace cohort of a 55{,}379-session raw archive; EV~WATTS uses
charge-port identifiers as driver proxies).}
\label{tab:sources}
\centering\small
\begin{tabular}{@{}lllll@{}}
\toprule
Corpus & Span & Venue & Fitted scale & Policy \\
\midrule
ACN-Data & 2019--21 & workplace (3 sites) & 632 users / 41{,}774 sess. & fitted \\
EV~WATTS & 2019--23 & workplace (public) & 3{,}356 ports / 1{,}265{,}017 sess. & fitted \\
ElaadNL & 2020--24 & EU public & 1{,}231 drivers / 55{,}201 sess. & fitted \\
...
often than intuition suggests (77\% of ACN drivers at $\phifreq \le 0.3$),
...
\begin{figure}[t]
  ...
  weights, places 77\% of drivers at $\phifreq \le 0.3$; the dashed box is a
...
own fit reduces its fitted-CDF-versus-source arrival KS from $0.196$ to
$0.040$ (\S\ref{sec:behfidelity}). The fitted arrival
