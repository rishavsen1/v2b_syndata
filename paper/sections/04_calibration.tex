...
informative: real workplace drivers plug in far less often than intuition
suggests (76\% of ACN drivers at $\phifreq \le 0.3$), which the calibrated
grids encode and hand-authored grids would have missed.
...
\begin{figure}[t]
  \centering
  \framebox[\linewidth]{\rule{0pt}{3.4cm} Fig.~3 placeholder: arrival mixture}
